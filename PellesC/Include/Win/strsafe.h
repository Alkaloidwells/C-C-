...
__declspec(noretchk) STRSAFEWORKERAPI _StringExHandleFillBehindNullA(STRSAFE_LPSTR pszDestEnd, size_t cbRemaining, DWORD dwFlags)
{
...
__declspec(noretchk) STRSAFEWORKERAPI _StringExHandleFillBehindNullW(STRSAFE_LPWSTR pszDestEnd, size_t cbRemaining, DWORD dwFlags)
{
...
__declspec(noretchk) STRSAFEWORKERAPI _StringExHandleOtherFlagsA(STRSAFE_LPSTR pszDest, size_t cbDest, size_t cchOriginalDestLength, STRSAFE_LPSTR * ppszDestEnd, size_t * pcchRemaining, DWORD dwFlags) {
...
__declspec(noretchk) STRSAFEWORKERAPI _StringExHandleOtherFlagsW(STRSAFE_LPWSTR pszDest, size_t cbDest, size_t cchOriginalDestLength, STRSAFE_LPWSTR * ppszDestEnd, size_t * pcchRemaining, DWORD dwFlags) {
