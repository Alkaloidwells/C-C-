...
extern char * __cdecl strcat(char * restrict, const char * restrict);
extern char * __cdecl strchr(const char *, int);
extern int __cdecl strcmp(const char *, const char *);
extern char * __cdecl strcpy(char * restrict, const char * restrict);
extern size_t __cdecl strcspn(const char *, const char *);
extern size_t __cdecl strlen(const char *);
extern char * __cdecl strncat(char * restrict, const char * restrict, size_t);
extern int __cdecl strncmp(const char *, const char *, size_t);
extern char * __cdecl strncpy(char * restrict, const char * restrict, size_t);
...
/* declarations */
extern _CRTUSE errno_t __cdecl memcpy_s(void * restrict, rsize_t, const void * restrict, rsize_t);
extern _CRTUSE errno_t __cdecl memmove_s(void *, rsize_t, const void *, rsize_t);
#if __POCC_STDC_VERSION__ >= 201112L
extern _CRTUSE errno_t __cdecl memset_s(void * restrict, rsize_t, int, rsize_t);
#endif /* __POCC_STDC_VERSION__ >= 201112L */
extern _CRTUSE errno_t __cdecl strcpy_s(char * restrict, rsize_t, const char * restrict);
extern _CRTUSE errno_t __cdecl strncpy_s(char * restrict, rsize_t, const char * restrict, rsize_t);
extern _CRTUSE errno_t __cdecl strcat_s(char * restrict, rsize_t, const char * restrict);
extern _CRTUSE errno_t __cdecl strncat_s(char * restrict, rsize_t, const char * restrict, rsize_t);
extern char * __cdecl strtok_s(char * restrict, rsize_t * restrict, const char * restrict, char ** restrict);
extern _CRTUSE errno_t __cdecl strerror_s(char *, rsize_t, errno_t);
