...
#if __POCC__ < 900
#error <wchar.h> need POCC version 9.0 or higher
#endif /* __POCC__ < 900 */
...
extern int __cdecl vwprintf(const wchar_t * restrict, va_list);
extern _CRTCHK(printf,1,2) int __cdecl wprintf(const wchar_t * restrict, ...);
...
extern wchar_t * __cdecl wcscpy(wchar_t * restrict, const wchar_t * restrict);
...
extern wchar_t * __cdecl wmemcpy(wchar_t * restrict, const wchar_t * restrict, size_t);
extern wchar_t * __cdecl wmemmove(wchar_t *, const wchar_t *, size_t);
extern wchar_t * __cdecl wmemset(wchar_t *, wchar_t, size_t);
...
/* general wide-string utilities */
extern _CRTUSE errno_t __cdecl wcscpy_s(wchar_t * restrict, rsize_t, const wchar_t * restrict);
extern _CRTUSE errno_t __cdecl wcsncpy_s(wchar_t * restrict, rsize_t, const wchar_t * restrict, rsize_t);
extern _CRTUSE errno_t __cdecl wmemcpy_s(wchar_t * restrict, rsize_t, const wchar_t * restrict, rsize_t);
extern _CRTUSE errno_t __cdecl wmemmove_s(wchar_t *, rsize_t, const wchar_t *, rsize_t);
extern _CRTUSE errno_t __cdecl wcscat_s(wchar_t * restrict, rsize_t, const wchar_t * restrict);
extern _CRTUSE errno_t __cdecl wcsncat_s(wchar_t * restrict, rsize_t, const wchar_t * restrict, rsize_t);
...
/* extended multibyte and wide-character conversion utilities */
extern _CRTUSE errno_t __cdecl wcrtomb_s(size_t * restrict, char * restrict, rsize_t, wchar_t, mbstate_t * restrict);
extern _CRTUSE errno_t __cdecl mbsrtowcs_s(size_t * restrict, wchar_t * restrict, rsize_t, const char ** restrict, rsize_t, mbstate_t * restrict);
extern _CRTUSE errno_t __cdecl wcsrtombs_s(size_t * restrict, char * restrict, rsize_t, const wchar_t ** restrict, rsize_t, mbstate_t * restrict);
...
extern _CRTUSE struct FILE * __cdecl open_wmemstream(wchar_t **, size_t *);
