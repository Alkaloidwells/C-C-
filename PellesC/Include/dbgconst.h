...
#define PODBG_SIGNATURE_V1  PODBG_MAKE_SIGNATURE('P','O','1','0')  /* Pelles C v1.0 */

/* Current signature */
#define PODBG_SIGNATURE  PODBG_SIGNATURE_V1

/* Known versions */
#define PODBG_PUBLIC_SYMBOL_VERSION_1  1
#define PODBG_SYMBOLS_VERSION_1  1
#define PODBG_TYPES_VERSION_1  1

/* Current versions */
#define PODBG_PUBLIC_SYMBOL_VERSION  PODBG_PUBLIC_SYMBOL_VERSION_1
#define PODBG_SYMBOLS_VERSION  PODBG_SYMBOLS_VERSION_1
...
typedef enum PODBG_SYM_T {
    ...
    PODBG_SYM_PUBLIC = 0x000F,          /* public symbol */
...
typedef enum PODBG_KINDMODE_T {
    ...
    PODBG_KM_COMPLEX = 5,               /* complex number size values */
