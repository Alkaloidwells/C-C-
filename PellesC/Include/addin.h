 ...
 * File    : addin.h                                                        *
 *                                                                          *
 * Purpose : Definitions for Pelles C add-in API 9.00.                      *
 *                                                                          *
 * History : Date      Reason                                               *
 *           04-01-28  Created                                              *
...
#pragma deprecated(AIM_ADD_COMMAND_A)
#pragma deprecated(AIM_OPEN_DOCUMENT_A)
#pragma deprecated(AIM_ADD_TAB_PAGE_A)
#pragma deprecated(AIM_WRITE_OUTPUT_A)
#pragma deprecated(AIM_ADD_FILE_TYPE_A)
#pragma deprecated(AIM_ADD_PROJECT_FILE_A)
#pragma deprecated(AIM_DELETE_PROJECT_FILE_A)
#pragma deprecated(AIM_RENAME_PROJECT_FILE_A)
#pragma deprecated(AIM_EXCLUDE_PROJECT_FILE_A)
#pragma deprecated(AIM_ENUM_PROJECT_FILES_A)
#pragma deprecated(AIM_GET_PROJECT_SYMBOL_A)
#pragma deprecated(AIM_SET_PROJECT_SYMBOL_A)
#pragma deprecated(AIM_GET_PROJECT_SHELLS_A)
#pragma deprecated(AIM_SET_PROJECT_SHELLS_A)
#pragma deprecated(AIM_GET_ACTIVE_PROJECT_A)
#pragma deprecated(AIM_SET_ACTIVE_PROJECT_A)
#pragma deprecated(AIM_ADD_WORKSPACE_PROJECT_A)
#pragma deprecated(AIM_DELETE_WORKSPACE_PROJECT_A)
#pragma deprecated(AIM_ENUM_WORKSPACE_PROJECTS_A)
#pragma deprecated(AIM_SET_PROJECT_BREAKPOINT_A)
#pragma deprecated(AIM_REMOVE_PROJECT_BREAKPOINT_A)
#pragma deprecated(AIM_ENUM_PROJECT_BREAKPOINTS_A)
#pragma deprecated(AIM_GET_DOCUMENT_INFO_A)
#pragma deprecated(AIM_SET_DOCUMENT_INFO_A)
#pragma deprecated(AIM_GET_SOURCE_TEXT_A)
#pragma deprecated(AIM_SET_SOURCE_TEXT_A)
#pragma deprecated(AIM_GET_SOURCE_LINE_A)
#pragma deprecated(AIM_GET_SOURCE_SELECTION_TEXT_A)
#pragma deprecated(AIM_REPLACE_SOURCE_SELECTION_TEXT_A)
#pragma deprecated(AIM_FIND_SOURCE_TEXT_A)

typedef __declspec(deprecated) struct tagADDIN_ADD_COMMAND_A {
...
typedef __declspec(deprecated) struct tagADDIN_DOCUMENT_INFO_A {
    UINT cbSize;                        // Size of this structure (version control).
...
typedef __declspec(deprecated) struct tagADDIN_ENUM_PROJECT_FILES_A {
    UINT cbSize;                        // Size of this structure (version control).
...
typedef __declspec(deprecated) struct tagADDIN_ENUM_WORKSPACE_PROJECTS_A {  /* (4.00) */
    UINT cbSize;                        // Size of this structure (version control).
...
typedef __declspec(deprecated) struct tagADDIN_PROJECT_BREAKPOINT_A {  /* (4.00) */
    UINT cbSize;                        // Size of this structure (version control).
...
typedef __declspec(deprecated) struct tagADDIN_ENUM_PROJECT_BREAKPOINTS_A {  /* (4.00) */
    UINT cbSize;                        // Size of this structure (version control).
...
typedef __declspec(deprecated) struct tagADDIN_ADD_FILE_TYPE_A {  /* [DEPRECATED] */
    UINT cbSize;                        // Size of this structure (version control).
...
enum ADDIN_DEBUG_TYPE {  /* (8.00) */
    ...
    ADDIN_DBGTYPE_CV_NB11 = 1,          // [DEPRECATED] CodeView (Microsoft, 32-bit).
    ADDIN_DBGTYPE_CV_PO32 = 2,          // [DEPRECATED] CodeView (Pelles C, 32-bit).
    ADDIN_DBGTYPE_CV_PO64 = 3,          // [DEPRECATED] CodeView (Pelles C, 64-bit).
    ADDIN_DBGTYPE_COFF = 4,             // COFF.
    ADDIN_DBGTYPE_EXPORTS = 5,          // Exports.
    ADDIN_DBGTYPE_PO10 = 6,             // Pelles C Debug Info v1.0 (9.00).
};
#pragma deprecated(ADDIN_DBGTYPE_CV_NB11, ADDIN_DBGTYPE_CV_PO32, ADDIN_DBGTYPE_CV_PO64)
...
typedef struct tagADDIN_DEBUG_EXCEPTION_W {  /* (9.00) */
    UINT cbSize;                        // Size of this structure (version control).
    LPCWSTR pszDescription;             // Exception description.
...
#define AddIn_GetProjectTargetW(hwnd,pch,cchMax)  (int)SNDMSG((hwnd),AIM_GET_PROJECT_TARGET_W,(WPARAM)(int)(cchMax),(LPARAM)(LPWSTR)(pch))
...
#define AddIn_GetProjectModeW(hwnd,pch,cchMax)  (int)SNDMSG((hwnd),AIM_GET_PROJECT_MODE_W,(WPARAM)(int)(cchMax),(LPARAM)(LPWSTR)(pch))
#define AddIn_SetProjectModeW(hwnd,pszName)  (BOOL)SNDMSG((hwnd),AIM_SET_PROJECT_MODE_W,0,(LPARAM)(LPCWSTR)(pszName))
#define AddIn_AddProjectModeW(hwnd,pszName)  (BOOL)SNDMSG((hwnd),AIM_ADD_PROJECT_MODE_W,0,(LPARAM)(LPCWSTR)(pszName))
#define AddIn_DeleteProjectModeW(hwnd,pszName)  (BOOL)SNDMSG((hwnd),AIM_DELETE_PROJECT_MODE_W,0,(LPARAM)(LPCWSTR)(pszName))
...
#define AddIn_SetSourceLineW(hwnd,line,psz)  (BOOL)SNDMSG((hwnd),AIM_SET_SOURCE_LINE_W,(WPARAM)(int)(line),(LPARAM)(LPCWSTR)(psz))
