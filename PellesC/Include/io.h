...
#if __POCC__ < 900
#error <io.h> need POCC version 9.0 or higher
#endif /* __POCC__ < 900 */
...
extern int __cdecl _chsize64(int, long long);
extern int __cdecl _close(int);
extern int __cdecl _commit(int);
extern _CRTUSE int __cdecl _creat(const char *, int);
extern _CRTUSE int __cdecl _dup(int);
...
extern _CRTUSE intptr_t __cdecl _findfirst(const char *, struct _finddata_t *);
extern _CRTUSE intptr_t __cdecl _findfirst64(const char *, struct _finddata64_t *);
...
extern _CRTUSE int __cdecl _open(const char *, int, ...);
...
extern _CRTUSE int __cdecl _sopen(const char *, int, int, ...);
extern int __cdecl _symlink(const char *, const char *);
...
extern _CRTUSE int __cdecl _wcreat(const wchar_t *, int);
extern _CRTUSE intptr_t __cdecl _wfindfirst(const wchar_t *, struct _wfinddata_t *);
extern _CRTUSE intptr_t __cdecl _wfindfirst64(const wchar_t *, struct _wfinddata64_t *);
extern int __cdecl _wfindnext(intptr_t, struct _wfinddata_t *);
extern int __cdecl _wfindnext64(intptr_t, struct _wfinddata64_t *);
extern _CRTUSE int __cdecl _wopen(const wchar_t *, int, ...);
extern _CRTUSE int __cdecl _wsopen(const wchar_t *, int, int, ...);
extern int __cdecl _wsymlink(const wchar_t *, const wchar_t *);
