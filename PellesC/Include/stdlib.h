...
extern _CRTUSE _CRTMEM void * __cdecl calloc(size_t, size_t);
...
extern _CRTUSE _CRTMEM void * __cdecl malloc(size_t);
...
extern int __cdecl _rand_s(unsigned int *);
extern _CRTUSE _CRTMEM _CRTFRE(1) void * __cdecl realloc(void *, size_t);
...
extern _CRTUSE _CRTMEM void * __cdecl aligned_alloc(size_t, size_t);
...
extern unsigned short __cdecl _bswap16(unsigned short);
extern unsigned long long __cdecl _bswap64(unsigned long long);

extern _CRTUSE _CRTMEM void * __cdecl _mm_malloc(size_t, size_t);
...
extern _CRTUSE errno_t __cdecl getenv_s(size_t * restrict, char * restrict, rsize_t, const char * restrict);
extern void * __cdecl bsearch_s(const void *, const void *, rsize_t, rsize_t, __cmpfunc_s *, void *);
extern _CRTUSE errno_t __cdecl qsort_s(void *, rsize_t, rsize_t, __cmpfunc_s *, void *);
extern _CRTUSE errno_t __cdecl wctomb_s(int * restrict, char * restrict, rsize_t, wchar_t);
extern _CRTUSE errno_t __cdecl mbstowcs_s(size_t * restrict, wchar_t * restrict, rsize_t, const char * restrict, rsize_t);
extern _CRTUSE errno_t __cdecl wcstombs_s(size_t * restrict, char * restrict, rsize_t, const wchar_t * restrict, rsize_t);
