...
extern intmax_t __cdecl wcstoimax(const __WCHAR_TYPE__ * restrict, __WCHAR_TYPE__ ** restrict, int);
extern uintmax_t __cdecl wcstoumax(const __WCHAR_TYPE__ * restrict, __WCHAR_TYPE__ ** restrict, int);
