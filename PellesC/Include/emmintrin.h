...
static inline __m128i __cdecl _mm_set_epi8(
...
#define _CRTPCK(a,b,c,d)  (((unsigned char)(d)<<24)|((unsigned char)(c)<<16)|((unsigned char)(b)<<8)|((unsigned char)(a)))
    return _mm_set_epi32(_CRTPCK(n04,n03,n02,n01), _CRTPCK(n08,n07,n06,n05), _CRTPCK(n12,n11,n10,n09), _CRTPCK(n16,n15,n14,n13));
#undef _CRTPCK
}

static inline __m128i __cdecl _mm_set_epi16(
    short n1, short n2, short n3, short n4,
    short n5, short n6, short n7, short n8)
{
...
static inline __m128i __cdecl _mm_setr_epi8(
    signed char n01, signed char n02, signed char n03, signed char n04,
    signed char n05, signed char n06, signed char n07, signed char n08,
    signed char n09, signed char n10, signed char n11, signed char n12,
    signed char n13, signed char n14, signed char n15, signed char n16)
...
#define _CRTPCK(a,b,c,d)  (((unsigned char)(a)<<24)|((unsigned char)(b)<<16)|((unsigned char)(c)<<8)|((unsigned char)(d)))
    return _mm_setr_epi32(_CRTPCK(n04,n03,n02,n01), _CRTPCK(n08,n07,n06,n05), _CRTPCK(n12,n11,n10,n09), _CRTPCK(n16,n15,n14,n13));
#undef _CRTPCK
}

static inline __m128i __cdecl _mm_setr_epi16(
    short n1, short n2, short n3, short n4,
    short n5, short n6, short n7, short n8)
{
