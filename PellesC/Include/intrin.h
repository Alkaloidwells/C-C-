...
#if __POCC__ < 900
#error <intrin.h> need POCC version 9.0 or higher
#endif /* __POCC__ < 900 */
...
_INTRIN_X64_(unsigned long long __cdecl _rotl64(unsigned long long, int))
_INTRIN_X64_(unsigned long long __cdecl _rotr64(unsigned long long, int))
...
_INTRIN_X86_X64_(unsigned char __cdecl _rotl8(unsigned char, unsigned char))
_INTRIN_X86_X64_(unsigned short __cdecl _rotl16(unsigned short, unsigned char))
_INTRIN_X86_X64_(unsigned char __cdecl _rotr8(unsigned char, unsigned char))
_INTRIN_X86_X64_(unsigned short __cdecl _rotr16(unsigned short, unsigned char))
...
_INTRIN_X86_(unsigned int __cdecl __getflags(void))
_INTRIN_X64_(unsigned long long __cdecl __getflags(void))

_INTRIN_X86_X64_(unsigned int __cdecl _bswap(unsigned int))
_INTRIN_X86_X64_(unsigned short __cdecl _bswap16(unsigned short))
_INTRIN_X86_X64_(unsigned long long __cdecl _bswap64(unsigned long long))
...
/* "somewhere else" */
_INTRIN_X86_X64_(void __cdecl _m_prefetchw(void *))
