...
extern void __cdecl _xsavec(void *, unsigned long long);  /* xsavec */
extern void __cdecl _xsaves(void *, unsigned long long);  /* xsaves */
extern void __cdecl _xrstors(const void *, unsigned long long);  /* xrstors */
...
extern void __cdecl _xsavec64(void *, unsigned long long);  /* xsavec64 */
extern void __cdecl _xsaves64(void *, unsigned long long);  /* xsaves64 */
extern void __cdecl _xrstors64(const void *, unsigned long long);  /* xrstors64 */
...
static inline __m256i __cdecl _mm256_set_epi8(
    signed char n01, signed char n02, signed char n03, signed char n04,
    signed char n05, signed char n06, signed char n07, signed char n08,
    signed char n09, signed char n10, signed char n11, signed char n12,
    signed char n13, signed char n14, signed char n15, signed char n16,
    signed char n17, signed char n18, signed char n19, signed char n20,
    signed char n21, signed char n22, signed char n23, signed char n24,
    signed char n25, signed char n26, signed char n27, signed char n28,
    signed char n29, signed char n30, signed char n31, signed char n32)
{
    __m128i lo = _mm_setzero_si128();
    __m128i hi = _mm_setzero_si128();

    lo = _mm_insert_epi8(lo, n32, 0);  hi = _mm_insert_epi8(hi, n16, 0);
    lo = _mm_insert_epi8(lo, n31, 1);  hi = _mm_insert_epi8(hi, n15, 1);
    lo = _mm_insert_epi8(lo, n30, 2);  hi = _mm_insert_epi8(hi, n14, 2);
    lo = _mm_insert_epi8(lo, n29, 3);  hi = _mm_insert_epi8(hi, n13, 3);
    lo = _mm_insert_epi8(lo, n28, 4);  hi = _mm_insert_epi8(hi, n12, 4);
    lo = _mm_insert_epi8(lo, n27, 5);  hi = _mm_insert_epi8(hi, n11, 5);
    lo = _mm_insert_epi8(lo, n26, 6);  hi = _mm_insert_epi8(hi, n10, 6);
    lo = _mm_insert_epi8(lo, n25, 7);  hi = _mm_insert_epi8(hi, n09, 7);
    lo = _mm_insert_epi8(lo, n24, 8);  hi = _mm_insert_epi8(hi, n08, 8);
    lo = _mm_insert_epi8(lo, n23, 9);  hi = _mm_insert_epi8(hi, n07, 9);
    lo = _mm_insert_epi8(lo, n22, 10); hi = _mm_insert_epi8(hi, n06, 10);
    lo = _mm_insert_epi8(lo, n21, 11); hi = _mm_insert_epi8(hi, n05, 11);
    lo = _mm_insert_epi8(lo, n20, 12); hi = _mm_insert_epi8(hi, n04, 12);
    lo = _mm_insert_epi8(lo, n19, 13); hi = _mm_insert_epi8(hi, n03, 13);
    lo = _mm_insert_epi8(lo, n18, 14); hi = _mm_insert_epi8(hi, n02, 14);
    lo = _mm_insert_epi8(lo, n17, 15); hi = _mm_insert_epi8(hi, n01, 15);

    return _mm256_insertf128_si256(_mm256_castsi128_si256(lo), hi, 1);
}

static inline __m256i __cdecl _mm256_setr_epi8(
    signed char n01, signed char n02, signed char n03, signed char n04,
    signed char n05, signed char n06, signed char n07, signed char n08,
    signed char n09, signed char n10, signed char n11, signed char n12,
    signed char n13, signed char n14, signed char n15, signed char n16,
    ...
    signed char n29, signed char n30, signed char n31, signed char n32)
{
    ...
    lo = _mm_insert_epi8(lo, n01, 0);  hi = _mm_insert_epi8(hi, n17, 0);
    lo = _mm_insert_epi8(lo, n02, 1);  hi = _mm_insert_epi8(hi, n18, 1);
    lo = _mm_insert_epi8(lo, n03, 2);  hi = _mm_insert_epi8(hi, n19, 2);
    lo = _mm_insert_epi8(lo, n04, 3);  hi = _mm_insert_epi8(hi, n20, 3);
    lo = _mm_insert_epi8(lo, n05, 4);  hi = _mm_insert_epi8(hi, n21, 4);
    lo = _mm_insert_epi8(lo, n06, 5);  hi = _mm_insert_epi8(hi, n22, 5);
    lo = _mm_insert_epi8(lo, n07, 6);  hi = _mm_insert_epi8(hi, n23, 6);
    lo = _mm_insert_epi8(lo, n08, 7);  hi = _mm_insert_epi8(hi, n24, 7);
    lo = _mm_insert_epi8(lo, n09, 8);  hi = _mm_insert_epi8(hi, n25, 8);
    lo = _mm_insert_epi8(lo, n10, 9);  hi = _mm_insert_epi8(hi, n26, 9);
    lo = _mm_insert_epi8(lo, n11, 10); hi = _mm_insert_epi8(hi, n27, 10);
    lo = _mm_insert_epi8(lo, n12, 11); hi = _mm_insert_epi8(hi, n28, 11);
    lo = _mm_insert_epi8(lo, n13, 12); hi = _mm_insert_epi8(hi, n29, 12);
    lo = _mm_insert_epi8(lo, n14, 13); hi = _mm_insert_epi8(hi, n30, 13);
    lo = _mm_insert_epi8(lo, n15, 14); hi = _mm_insert_epi8(hi, n31, 14);
    lo = _mm_insert_epi8(lo, n16, 15); hi = _mm_insert_epi8(hi, n32, 15);

    return _mm256_insertf128_si256(_mm256_castsi128_si256(lo), hi, 1);
}

static inline __m256i __cdecl _mm256_set_epi16(
    short n01, short n02, short n03, short n04,
    short n05, short n06, short n07, short n08,
    short n09, short n10, short n11, short n12,
    short n13, short n14, short n15, short n16)
{
    __m128i lo = _mm_setzero_si128();
    __m128i hi = _mm_setzero_si128();

    lo = _mm_insert_epi16(lo, n16, 0); hi = _mm_insert_epi16(hi, n08, 0);
    lo = _mm_insert_epi16(lo, n15, 1); hi = _mm_insert_epi16(hi, n07, 1);
    lo = _mm_insert_epi16(lo, n14, 2); hi = _mm_insert_epi16(hi, n06, 2);
    lo = _mm_insert_epi16(lo, n13, 3); hi = _mm_insert_epi16(hi, n05, 3);
    lo = _mm_insert_epi16(lo, n12, 4); hi = _mm_insert_epi16(hi, n04, 4);
    lo = _mm_insert_epi16(lo, n11, 5); hi = _mm_insert_epi16(hi, n03, 5);
    lo = _mm_insert_epi16(lo, n10, 6); hi = _mm_insert_epi16(hi, n02, 6);
    lo = _mm_insert_epi16(lo, n09, 7); hi = _mm_insert_epi16(hi, n01, 7);

    return _mm256_insertf128_si256(_mm256_castsi128_si256(lo), hi, 1);
}

static inline __m256i __cdecl _mm256_setr_epi16(
    short n01, short n02, short n03, short n04,
    short n05, short n06, short n07, short n08,
    short n09, short n10, short n11, short n12,
    short n13, short n14, short n15, short n16)
{
    ...
    lo = _mm_insert_epi16(lo, n01, 0); hi = _mm_insert_epi16(hi, n09, 0);
    lo = _mm_insert_epi16(lo, n02, 1); hi = _mm_insert_epi16(hi, n10, 1);
    lo = _mm_insert_epi16(lo, n03, 2); hi = _mm_insert_epi16(hi, n11, 2);
    lo = _mm_insert_epi16(lo, n04, 3); hi = _mm_insert_epi16(hi, n12, 3);
    lo = _mm_insert_epi16(lo, n05, 4); hi = _mm_insert_epi16(hi, n13, 4);
    lo = _mm_insert_epi16(lo, n06, 5); hi = _mm_insert_epi16(hi, n14, 5);
    lo = _mm_insert_epi16(lo, n07, 6); hi = _mm_insert_epi16(hi, n15, 6);
    lo = _mm_insert_epi16(lo, n08, 7); hi = _mm_insert_epi16(hi, n16, 7);

    return _mm256_insertf128_si256(_mm256_castsi128_si256(lo), hi, 1);
}

static inline __m256i __cdecl _mm256_set1_epi8(signed char n) {
...
extern int __cdecl _rdrand64_step(unsigned long long *);  /* composite (rdrand) */
...
extern int __cdecl _rdseed64_step(unsigned long long *);  /* composite (rdseed) */

/* add with carry */
extern unsigned char __cdecl _addcarryx_u32(unsigned char, unsigned int, unsigned int, unsigned int *);  /* composite (adcx) */
#if __POCC_TARGET__ == 3
extern unsigned char __cdecl _addcarryx_u64(unsigned char, unsigned long long, unsigned long long, unsigned long long *);  /* composite (adcx) */
#endif /* __POCC_TARGET__ == 3 */
 ...
 */
extern unsigned int __cdecl _readfsbase_u32(void);  /* rdfsbase */
extern unsigned long long __cdecl _readfsbase_u64(void);  /* rdfsbase */
extern unsigned int __cdecl _readgsbase_u32(void);  /* rdgsbase */
extern unsigned long long __cdecl _readgsbase_u64(void);  /* rdgsbase */

extern void __cdecl _writefsbase_u32(unsigned int);  /* wrfsbase */
extern void __cdecl _writefsbase_u64(unsigned long long);  /* wrfsbase */
extern void __cdecl _writegsbase_u32(unsigned int);  /* wrgsbase */
extern void __cdecl _writegsbase_u64(unsigned long long);  /* wrgsbase */
#endif /* __POCC_TARGET__ == 3 */
